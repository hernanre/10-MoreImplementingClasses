...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        corner_4 = rg.Point(intersection_center.x + letter_thickness/2, intersection_center.y - letter_thickness/2 + height)
    ...
    def move_by(self, dx, dy):
        ...
        Type hints:
          ...
          :type dy: int
        """
        # self.h_rect.corner_1.x = self.h_rect.x + dx
        # self.h_rect.y = self.h_rect.y + dy
        # self.v_rect.x = self.v_rect.x + dx
        # self.v_rect.y = self.v_rect.y + dy
